...
import { centrarTexto } from './utils/centerText';
import { printerReportModel } from './utils/printer';
...
export const generateOperatingPeriodReport = (period: any) => {
    ...
    'Ventas por metodo de pago',
    {
      ...
      body: [
        ...
        [
          ...
          `$${formatToCurrency(closing.totalTransferAmount)}`,
        ],
      ],
      head: [['Tipo', 'Cantidad']],
    },
  ...
  centrarTexto( {doc, text: "___________________________________________________", y: 274, headerStyles: headerStyle});
