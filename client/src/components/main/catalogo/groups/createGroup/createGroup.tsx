...
export default function CreateGroup({ data, action }: Props) {
  const { modifiers, dishes, createGroup, isLoading, error } = useAdditions();
  ...
  return (
    <div className={styles.screen}>
      <div>
        ...
        <header>Editar grupo EDITAR</header>
        <main>
          <div>
            <h3>General</h3>
            <input
